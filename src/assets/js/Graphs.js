...
class Graph {
    ...
    constructor(canvasid, connectable = false, euler = false, fps = 60, editable = true, loadContext = null) {
    ...
    activate_building() {
        this.connectionMode = (this.euler === true ? "directional" : "biDirectional");
    ...
    node(x = false, y = false, r = false, text = "", kotaId = 0) {
        let node = new Graph._node(this.id, x = x, y = y, r = r, text = text, kotaId = kotaId);
...
Graph._node = function (contextid, x = false, y = false, r = false, text = "", kotaId = 0) {
    this.type = "node"
    this.children = [];
    this.edges = {};
    this.contextid = contextid;
